...
<x-layout theTitle="Payroll Records" href="/payroll">
    <div class="card">
        <div class="card-body">
            <div class="mt-3">
            ...
            <div class="search-bar mt-3">
                <form class="search-form d-flex justify-content-end" method="GET" action="{{ url('/payroll/search') }}">
                    ...
                    <tbody>
                        @foreach ($payrolls as $payroll)
                            <tr>
                                ...
                                <td><a href="/payroll/{{ $payroll->id }}"><button class="btn btn-success">Edit</button></a></td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
