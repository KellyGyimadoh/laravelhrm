@props(['query'=>''])
<x-layout theTitle="All Admin" href="/workers/admin">
    <div class="card">

        <div class="card-body">
            <div class="mt-3"><a href="/workers/admin"><button class="btn btn-sm btn-primary" type="submit" title="Search">
                View All Admin
            </button></a></div>
            @if($query)
        ...
        @if($workers->isEmpty())
         <p class="text-danger">No workers found.</p>
            <div class="search-bar mt-3">
                <form class="search-form d-flex justify-content-end" method="GET" action="../search/admin/">
                    <input
                        type="text"
                        name="q"
                        placeholder="Search"
