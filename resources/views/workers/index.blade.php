@props(['query'=>''])
<x-layout theTitle="All Workers" href="/workers">
    <div class="card">

        <div class="card-body">
            <div class="mt-3"><a href="/workers"><button class="btn btn-sm btn-primary" type="submit" title="Search">
                View All Workers
            </button></a></div>
            @if($query)
        ...
        @if($workers->isEmpty())
         <p class="text-danger">No workers found.</p>
            <div class="search-bar mt-3">
                <form class="search-form d-flex justify-content-end" method="GET" action="search">
                    <input
                        type="text"
                        name="q"
                        placeholder="Search"
                    ...
                    <select name="role" class="w-25">
                        <option value="all" {{ request('role') == 'all' ? 'selected' : '' }}>All Workers</option>
