    ...
    <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
            ...
            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                ...
                <li>
                    <a class="dropdown-item d-flex align-items-center" href="/dashboardprofile/{{ Auth::user()->id }}">
                ...
                <li>
                    <a class="dropdown-item d-flex align-items-center" href="/leave/status/{{Auth::user()->id}}">
                        <i class="bi bi-gear"></i>
                        <span>Check Leave Status</span>
                    </a>
                </li>
                <li>
                    <hr class="dropdown-divider">
