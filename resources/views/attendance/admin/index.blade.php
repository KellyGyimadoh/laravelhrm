...
<x-layout theTitle="All Admin Attendance Today" href="/attendance/admin">
    <div class="card">
        <div class="card-body">
            <div class="mt-3">
            ...
            @else
                <div class="search-bar mt-3">
                    <form class="search-form d-flex justify-content-end" method="GET" action="/attendance/admin/search">
                    ...
                    <tbody>
                        @foreach ($workers as $worker)
                            <tr>
                                ...
                                <td>{{ $worker->attendance_for_today ? $worker->attendance_for_today->check_in_time : 'N/A' }}</td>
